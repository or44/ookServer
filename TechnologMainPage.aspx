                ...
                <div class="span12">
                    ...
                    <div class="widget white-full">
                        ...
                        <div class="widget-body">
                            ...
                            <asp:GridView ID="openBigs" runat="server" CssClass="table table-striped table-bordered table-advance table-hover" DataSourceID="SqlDataSourceopenBigs" OnSelectedIndexChanged="openBigs_SelectedIndexChanged">

                                <Columns>
                                    <asp:TemplateField HeaderText="פירוט" SortExpression="sentiment">
                                        <ItemTemplate>
                                            <%--<asp:Button ID="btnLink" runat="server" Text="לפרטי ההצעה" />--%>
                                            <asp:LinkButton ID="lnbtn" runat="server" OnClick="lnbtn_Click">לפרטי ההצעה</asp:LinkButton>
