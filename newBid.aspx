<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageAgent.master" AutoEventWireup="true" CodeFile="newBid.aspx.cs" Inherits="newBid" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <!----------------------------סקריפטים מקוריים של הדף (היו בתחתית הדף)---------------------------------->
    <%--    //popup--%>
    ...
    <script src="js/jQuery.dualListBox-1.3.js" type="text/javascript"></script>
    ...
    <script src="//code.jquery.com/ui/1.11.4/jquery-ui.js"></script>
    <%--    //popup--%>
    <!----------------------------העיצוב המקורי של הדף (היו בתחילת הדף)---------------------------------->
                ...
                <div class="span12">
                    ...
                    <div class="widget orange">
                        <div class="widget-title">
                            <h4>הזנת הצעה <i class="icon-reorder"></i></h4>
                        </div>
                            ...
                            <div class="cmxform form-horizontal">
                                ...
                                <div class="control-group">
                                    <div class="controls">
                                       ...
                                       <button id="AddNew" class="btn btn-large btn-danger" type="button" >&nbsp;לקוח חדש&nbsp;</button>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <%--<input type="text" id="datepicker" runat="server">--%><%--<input id="targetDate" type="date" runat="server" /> <asp:RequiredFieldValidator ID="rfvTargetDate" ControlToValidate="targetDate" runat="server" ErrorMessage="יש לבחור תאריך "></asp:RequiredFieldValidator>--%>
